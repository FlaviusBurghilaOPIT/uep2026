...
def seed_database(
    ...
    try:
        ...
        print(f"    • 6-digit OTP: {p_otp} (Paste this code into the mobile app)")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--patient-otp",
        default=None,
        help="Custom patient OTP code (defaults to dynamically generated 6-digit code or DEMO_PATIENT_OTP env)",
    )
