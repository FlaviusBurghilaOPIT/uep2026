...
# for local runs. Preset to empty rather than pop: app.database's load_dotenv()
# (override=False) re-populates absent keys from .env, but won't overwrite an
# existing one — and setup_tracing() treats "" as disabled.
