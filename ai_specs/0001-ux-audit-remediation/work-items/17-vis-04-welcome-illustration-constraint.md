...
## Acceptance criteria
- [x] Welcome hero image/illustration height is constrained to `clamp(120.h, 25.vh, 180.h)`.
- [x] Auth buttons and footer text remain fully visible above the fold on 568dp/600dp screen heights.
